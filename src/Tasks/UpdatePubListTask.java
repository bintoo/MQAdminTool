 ...
 * @author jzhou
 */
public class UpdatePubListTask extends UpdateContentTableTaskBase{

    public UpdatePubListTask(Component window, JTree tree, JTable table, DefaultMutableTreeNode node, String searchString, boolean showSystem, boolean loadNewData) {
    ...
    private void updateContent(){
        ...
        MQPubListResult result = MQPCF.GetPubList(queueManager, "*",  null, loadNewData);
        if(stopTask == false){
