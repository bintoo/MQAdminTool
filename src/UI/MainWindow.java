...
import UI.Misc.CustomTreeCellRenderer;
...
public class MainWindow extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        TreeView = new javax.swing.JTree() {
            ...
            public String getToolTipText(MouseEvent event) {
                ...
                TreePath path = TreeView.getClosestPathForLocation(event.getX(), event.getY());
                System.out.println(((TreeNodeObject)
                    ((DefaultMutableTreeNode) path.getLastPathComponent()).getUserObject()).ConnectionDetail.toString());
    ...
    javax.swing.ToolTipManager.sharedInstance().registerComponent(TreeView);
    //    javax.swing.ToolTipManager.sharedInstance().setDismissDelay(1000);
    //    javax.swing.ToolTipManager.sharedInstance().setReshowDelay(100);
...
//        }
    ...
    private void TreeViewMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TreeViewMouseEntered
//        int row = TreeView.getRowForLocation(evt.getPoint().x, evt.getPoint().y);
        System.out.println(evt.getComponent().toString());
       TreePath path = TreeView.getPathForLocation(evt.getX(), evt.getY());
       System.out.println(
               ((TreeNodeObject)
                       ((DefaultMutableTreeNode) path.getLastPathComponent()).getUserObject()).ConnectionDetail.toString());
    }//GEN-LAST:event_TreeViewMouseEntered
